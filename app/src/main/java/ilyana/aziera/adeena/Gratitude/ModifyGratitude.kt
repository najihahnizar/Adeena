...
class ModifyGratitude : Activity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_modify_gratitude)
    ...
    fun returnHome() {
        val home_intent = Intent(applicationContext, GratitudeActivity::class.java)
